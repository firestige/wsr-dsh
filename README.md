...
Release set `0.2.6` qualifies Execution `0.2.5`, Studio `0.1.2`, and suite `0.2.5` coordinates.
...
`dsh-wsr-execution@^0.2.5` and `dsh-wsr-studio@^0.1.2`. DeepSeek Harness
...
`wsr-execution-0.2.4.tgz` in release `0.2.4` (SHA-256
