...
const expectedIntegrity =
  "sha512-5OEZmmxlNm0g/EluczoubCOPy+PNXoJ+F/3sEVpwtutYTAnKXwLTQyqRPq1hCrWaljUKSGruuN9DtnxgCcK6hg==";
...
test("Studio locks the immutable shared BI registry candidate without source-path escape hatches", async () => {
  ...
  assert.equal(studio.dependencies["wsr-ui-core"], "0.1.0");
  assert.equal(installed.version, "0.1.0");
  assert.equal(
    installed.resolved,
    "https://registry.npmjs.org/wsr-ui-core/-/wsr-ui-core-0.1.0.tgz",
  );
